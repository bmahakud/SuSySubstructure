...
inputDir = "/eos/uscms/store/user/lpcsusyhad/SusyRA2Analysis2012/"+options.sample+"/"
...
for f in dirList : 
	...
	os.system( "sed -e 's|<SAMPLE>|{0}|g' -e 's|<FILE>|{1}|g'< runAddFatJetsToTree.tpl > runAddFatJetsToTree_{2}_{3}.sh".format( sample , f[:-5] , sample , ifile ) )
